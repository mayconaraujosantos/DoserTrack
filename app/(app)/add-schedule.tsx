  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setSuccessToast({
        ...
        message: medName
          ? `A agenda de ${medName} foi criada e as próximas doses já foram geradas.`
          : 'A agenda foi criada e as próximas doses já foram geradas.',
      });
    },
        ...
        <FormSection title="Medicamento">
          {medicines.length === 0 ? (
            <View style={styles.emptyMed}>
              ...
              <Text variant="body" style={styles.emptyMedTitle}>
                Nenhum medicamento cadastrado
              </Text>
              <Text variant="caption" color={C.sub} style={styles.emptyMedText}>
                Para criar um agendamento, cadastre um medicamento primeiro ou escaneie uma
                embalagem.
              </Text>
              <View style={styles.emptyMedActions}>
                <Button
                  variant="primary"
                  size="md"
                ...
                <Button
                  variant="secondary"
                  size="md"
                  onPress={() => router.push('/scan-medicine')}
...
const styles = StyleSheet.create({
  ...
  // Medicine selector
  emptyMed: { padding: 16, alignItems: 'center', gap: 10 },
  emptyMedTitle: { fontWeight: '700', textAlign: 'center' },
  emptyMedText: { textAlign: 'center', lineHeight: 18 },
  emptyMedActions: { width: '100%', gap: 10, marginTop: 6 },
